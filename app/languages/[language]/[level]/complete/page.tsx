...
export default function CompletionPage() {
  ...
  const currentLessonId = searchParams.get('lesson') || 'introduction';
  const lessons = levelUnits[level] || levelUnits.basic;
  const currentLessonIndex = lessons.indexOf(currentLessonId);
